...
```typescript fold file="./samples/_postback-nodejs.ts"

````
  </LanguageTab>

  <LanguageTab language="C#">
```csharp fold file="./samples/_postback-csharp.cs"
...
```python fold file="./samples/_postback-python.py"
...
```php fold file="./samples/_postback-php.php"
...
```java fold file="./samples/_postback-java.java"
...
```go fold file="./samples/_postback-go.go"
