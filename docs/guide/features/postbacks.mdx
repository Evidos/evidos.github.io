...
You can register a posback URL on the [Postbacks](https://portal.signhost.com/v2/developer/postbacks) page of the Signhost portal. Global Postback URLs will be used for every transaction.
