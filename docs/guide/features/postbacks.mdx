...
You can register a posback URL on the [Postbacks](https://portal.signhost.com/RegisteredPostbacks) page of the Signhost portal. Global Postback URLs will be used for every transaction.
...
:::note
IP whitelisting and certificate pinning should not be used as security measures because they are not always reliable. All security measures can be found and configured on the [Postbacks](https://portal.signhost.com/RegisteredPostbacks) page in the Signhost portal.
:::
